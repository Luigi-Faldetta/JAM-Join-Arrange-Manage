      ...
      >
        ...
        <div className="fixed inset-0 z-10 overflow-y-auto">
          <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
            <div className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg border-indigo-950 border-2">
              ...
              <div className="bg-gray-100 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                <button
                  ...
                  type="button"
                  className=" inline-flex w-full justify-center px-3 py-2  focus:outline-none focus:ring-red-300 rounded-md bg-red-200 text-sm font-semibold text-black shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-red-300 sm:ml-3 sm:w-auto"
                >
                  Delete
                </button>
                <button
